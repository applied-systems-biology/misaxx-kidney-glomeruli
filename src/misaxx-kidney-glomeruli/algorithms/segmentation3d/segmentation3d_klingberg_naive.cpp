...
#include "segmentation3d_klingberg_naive.h"
...
void misaxx_kidney_glomeruli::segmentation3d_klingberg_naive::work() {
...
void misaxx_kidney_glomeruli::segmentation3d_klingberg_naive::create_parameters(
